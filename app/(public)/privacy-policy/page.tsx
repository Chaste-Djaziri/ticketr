...
export const metadata = {
  ...
  description: "Learn about how Evently collects, uses, and protects your personal information.",
}
      ...
      <div className="container max-w-4xl mx-auto px-6">
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none">
          ...
          <p className="text-gray-600 dark:text-gray-300">
            Welcome to Evently. We respect your privacy and are committed to protecting your personal data. This privacy policy will inform you about how we look after your personal data when you visit our website and tell you about your privacy rights and how the law protects you.
          </p>
          ...
          <p className="text-gray-600 dark:text-gray-300 mt-4">
            Email: <a href="mailto:privacy@evently.com" className="text-primary hover:underline">privacy@evently.com</a>
          </p>
